...
// ** Avatars
import avatar1 from '@src/assets/images/avatars/avatar-blank.png'

const options = [
  { value: 'Donna Frank', label: 'Donna Frank', avatar: avatar1 },
  { value: 'Jane Foster', label: 'Jane Foster', avatar: avatar1 },
  { value: 'Gabrielle Robertson', label: 'Gabrielle Robertson', avatar: avatar1 },
  { value: 'Lori Spears', label: 'Lori Spears', avatar: avatar1 },
  { value: 'Sandy Vega', label: 'Sandy Vega', avatar: avatar1 },
  { value: 'Cheryl May', label: 'Cheryl May', avatar: avatar1 }
]
