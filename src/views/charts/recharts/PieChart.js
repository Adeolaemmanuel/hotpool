...
const SimplePieChart = props => {
  // ** Chart Data
  const data = [
    { name: 'Multipe PIN Trial&D', value: 50, color: props.series2 },
    { name: 'Invalid CVV', value: 85, color: props.series1 },
    { name: 'Declined OTP', value: 16, color: props.series5 },
    { name: 'Suspected Fraud', value: 50, color: props.series3 }
  ]
  /*eslint-disable */
