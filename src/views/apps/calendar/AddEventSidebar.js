...
const AddEventSidebar = props => {
  ...
  const guestsOptions = [
    ...
    { value: 'Jane Foster', label: 'Jane Foster', avatar: img1 },
    { value: 'Gabrielle Robertson', label: 'Gabrielle Robertson', avatar: img1 },
    { value: 'Lori Spears', label: 'Lori Spears', avatar: img1 },
    { value: 'Sandy Vega', label: 'Sandy Vega', avatar: img1 },
    { value: 'Cheryl May', label: 'Cheryl May', avatar: img1 }
  ]
