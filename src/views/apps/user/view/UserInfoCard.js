...
const UserInfoCard = ({ selectedUser }) => {
  ...
  const renderUserImg = () => {
    if (selectedUser !== null && selectedUser.avatar.length) {
      return (
        <div className='d-flex justify-content-between flex-sm-row flex-column w-100 mb-4'>
          <div className='d-flex flex-column justify-content-center w-md-50'>
            <img
              height='110'
              width='110'
              alt='user-avatar'
              src="https://teachfornigeria.s3.us-east-2.amazonaws.com/images/106dd0e2c200caddc309b69ea88a1f840.jpeg"
              className='img-fluid rounded mt-3 mb-2 mx-auto h-100'
          ...
          <div className='d-flex flex-column justify-content-center w-md-50'>
            <img
              ...
              width='110'
              alt='user-avatar'
              src="https://teachfornigeria.s3.us-east-2.amazonaws.com/images/426ab027748ca24edaa95db0fb246a991.jpeg"
              className='img-fluid rounded mt-3 mb-2 mx-auto d-block'
            />
            <span>ID Photo from Authority</span>
          </div>
        </div>
      )
    } else {
            ...
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  ...
                  <span>Oluwashola Ayande</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Username:</span>
                  <span>SholaAyande</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Selfie Registered:</span>
                  <span>Approved</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Confidence Index:</span>
                  <span>99%</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Liveness Check:</span>
                  <span>Passed</span>
                </li>
                <li className='mb-75'>
                ...
                <li className='mb-75'>
                  ...
                  <span className='text-capitalize'>Male</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Address:</span>
                  <span>33, Bamisile Allen Street, Kogi State, Nigeria</span>
                </li>
                <li className='mb-75'>
