...
const statusObj = {
  "Not Successful": "light-secondary",
  Successful: "light-success",
  "Network Error": "light-danger",
};
...
export const columns = [
  {
    ...
    cell: (row) => <span className="text-capitalize">{row.ReferenceNo}</span>,
  },
  {
    name: "Parameter",
    sortable: true,
    ...
    cell: (row) => <span className="text-capitalize">{row.Parameter}</span>,
  },
  {
    name: "Date",
    minWidth: "138px",
